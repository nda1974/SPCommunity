...
namespace SPOApp
{
    public static class Beredskab
    {
        

        

        public static List<BeredskabManualProperies> GetSourceFiles(ClientContext context, string sourceLibraryName)
        {
            ...
            List<BeredskabManualProperies> pages = new List<BeredskabManualProperies>();
        ...
        public static void CreateModernSitePages(ClientContext context, List<BeredskabManualProperies> pages)
        {

            //List<AnsvarManualProperies> sourcePages = pages;
            string targetContentTypeName = "BeredskabManual";
            foreach (var p in pages)
            {
                CreatePages(context, p, targetContentTypeName);
                //if (p.FileName.Equals("Statistik.aspx"))
                //{
                //    CreatePages(context, p, targetContentTypeName);
                //}
        ...
        private static void CreatePages(ClientContext context, BeredskabManualProperies p, string targetContentTypeName)
        {
