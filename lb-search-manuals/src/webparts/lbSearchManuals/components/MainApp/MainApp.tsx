...
import SPSearchService from '../../services/SPSeachService'
...
import { IMainAppProps } from './MainAppProps';
import { IMainAppState } from './MainAppState';
...
export default class MainApp extends React.Component<IMainAppProps, IMainAppState> {
    public constructor(props: IMainAppProps, state: IMainAppState){  
            super(props);  
